    ...
    Timepicker.prototype = {
        ...
        getTemplate: function() {
            ...
            if (this.showInputs) {
                ...
                secondTemplate = '<input type="text" class="bootstrap-timepicker-second" readonly maxlength="2"/>';
                meridianTemplate = '<input type="text" class="bootstrap-timepicker-meridian" readonly maxlength="2"/>';
            } else {
